...
| --- | --- | --- |
| "Totality" by Chris Kottke |  {{< br >}}{{< br >}} Concert ([PDF]({{< baseurl >}}/sections/assignments/totality/totality_conc)) {{< br >}}{{< br >}} Transposed ([PDF]({{< baseurl >}}/sections/assignments/totality/totality_trans)) {{< br >}}{{< br >}}  | [Audio and video]({{< baseurl >}}/sections/assignments/totality) |
| "Empty Bottles" by Mike Lee |  {{< br >}}{{< br >}} ([PDF]({{< baseurl >}}/sections/assignments/empty-bottles/empty_bottles)) {{< br >}}{{< br >}}  | [Audio and video]({{< baseurl >}}/sections/assignments/empty-bottles)